if __name__ == '__main__':
    ...
    PDE_CASE_INDEX = 0
    PDE_NAME = "Allen_Cahn"
    data_path = r"C:\Users\mehul\a Folder\DataPhysicsHybrid\data\128\allen_cahn_data(2).mat"
    data_label = torch.tensor(PDE_CASE_INDEX + 1)
    
    learning_rate, epochs, scheduler_step, scheduler_gamma = 0.0001, 100, 50, 0.85
    ntrain, ntest, batch_size, lbda, T, T0, step, S = 300, 100, 20, 1000, 20, 10, 1, 128
    ...
    gf_allen = new_gradfree_fun2.allen_cahn_gradient_free()
    allen_p_index, allen_invp_index = gf_allen.neighbour_index(x_f_train), gf_allen.inverse_index(x_f_train)
    ...
    # training only the gate parameters
        ...
        for ep in range(epochs):
            ...
            for xx, yy in train_loader:
                ...
                for t in range(0, T, step):
                    ...
                    loss += gf_allen.loss(all_u_train, all_u_sol, x_pf, x_f_train, y_pf, allen_p_index, allen_invp_index)
